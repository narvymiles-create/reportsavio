  ...
  public: {
    Tables: {
      ...
      division_rules: {
        ...
        Relationships: [
          {
            foreignKeyName: "division_rules_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      nursery_assessments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "nursery_assessments_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      nursery_classes: {
        ...
        Relationships: [
          {
            foreignKeyName: "nursery_classes_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      nursery_grade_colors: {
        ...
        Relationships: [
          {
            foreignKeyName: "nursery_grade_colors_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      nursery_learners: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "nursery_learners_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      nursery_learning_areas: {
        ...
        Relationships: [
          {
            foreignKeyName: "nursery_learning_areas_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      nursery_report_cards: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "nursery_report_cards_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      nursery_streams: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "nursery_streams_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
    ...
    Functions: {
      create_school_for_current_user: {
        Args: {
          _address: string
          _email: string
          _name: string
    ...
    Enums: {
      ...
      school_role: "school_admin" | "member"
